...
<tr>
	...
	<td>
Escenario 1: Visualización de planes disponibles<br><br>
Dado que el visitante está en el landing page<br><br>
Cuando se encuentra en la sección de planes<br><br>
