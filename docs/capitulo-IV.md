...
```dsl
workspace "SafeCar Ecosystem" "Sistema integral de monitoreo vehicular y gestión de talleres" {

    model {
        # PERSONAS (USERS)
        conductores = person "Conductores" {
            description "Propietarios de vehículos"
            tags "Person,Driver"
        }
        
        tallerMecanico = person "Taller/Mecánico" {
            description "Personal técnico que administra talleres, instala dispositivos y realiza servicios"
            tags "Person,Mechanic"
        }

        # SAFECAR ECOSYSTEM (SOFTWARE ECOSYSTEM)
        safecarEcosystem = softwareSystem "SafeCar Ecosystem" {
            description "Software Ecosystem"
            tags "Software Ecosystem,Internal"
            
            # SOFTWARE SYSTEMS INTERNOS
            mobileApp = container "SafeCar - Mobile App" {
                description "Interfaz principal del conductor para monitoreo vehicular y gestión de servicios"
                tags "Software System,Mobile,Internal"
            }

            workshopPortal = container "Workshop Portal" {
                description "Gestión completa de operaciones del taller y relación con clientes"
                tags "Software System,Web,Internal"
            }

            safecarPlatform = container "SafeCar Platform" {
                description "Núcleo de negocio que orquesta todos los bounded contexts del dominio SafeCar"
                tags "Software System,Core,Internal"
            }

            aiAnalytics = container "AI/Analytics" {
                description "Procesamiento avanzado de datos para detección de anomalías y predicciones"
                tags "Software System,AI,Internal"
            }

            notificationSystem = container "Notification System" {
                description "Envío de alertas, confirmaciones y comunicaciones a usuarios"
                tags "Software System,Messaging,Internal"
            }

            # HARDWARE SYSTEMS
            dispositivosIoT = container "Dispositivos IoT Vehículos" {
                description "Dispositivos físicos instalados en vehículos"
                tags "Hardware System,IoT,Internal"
            }
        }

        # EXTERNAL SYSTEMS
        vehiculo = softwareSystem "Driver's vehicle" {
            description "Unidad Vehicular"
            tags "Unit Vehicle,External"
        }

        twilio = softwareSystem "Twilio" {
            description "Servicio externo para envío de SMS y comunicaciones"
            tags "External System,SMS"
        }

        # RELACIONES PRINCIPALES
        
        # Persona -> Contenedores dentro del ecosistema
        conductores -> safecarEcosystem.mobileApp "Utiliza para monitoreo vehicular"
        tallerMecanico -> safecarEcosystem.workshopPortal "Utiliza para gestión del taller"

        # Relaciones internas del ecosistema
        safecarEcosystem.mobileApp -> safecarEcosystem.safecarPlatform "APIs REST/GraphQL"
        safecarEcosystem.workshopPortal -> safecarEcosystem.safecarPlatform "Sincronización bidireccional"
        safecarEcosystem.safecarPlatform -> safecarEcosystem.aiAnalytics "Consultas de análisis y predicciones"
        safecarEcosystem.aiAnalytics -> safecarEcosystem.notificationSystem "Alertas predictivas automáticas"
        safecarEcosystem.safecarPlatform -> safecarEcosystem.notificationSystem "Stream continuo de telemetría"
        safecarEcosystem.workshopPortal -> safecarEcosystem.notificationSystem "Recibe alertas push"
        
        # Relaciones con hardware
        safecarEcosystem.dispositivosIoT -> safecarEcosystem.safecarPlatform "Stream continuo de telemetría"
        safecarEcosystem.notificationSystem -> safecarEcosystem.dispositivosIoT "Alertas push"

        # Relaciones externas
        safecarEcosystem.dispositivosIoT -> vehiculo "Se implanta"
        safecarEcosystem.notificationSystem -> twilio "Utiliza"
    }

    views {
        systemLandscape "SafeCarLandscape" {
            title "SafeCar System Landscape"
            description "Vista de alto nivel del ecosistema SafeCar mostrando personas, sistemas internos y externos"
            include *
            autoLayout lr
        }

        systemContext safecarEcosystem "SafeCarContext" {
            title "SafeCar Ecosystem - System Context"
            description "Diagrama de contexto del ecosistema SafeCar"
            include *
            autoLayout lr
        }
