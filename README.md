...
<tr>
    ...
    <td style="text-align: left; padding: 15px;">
        ...
        <div style="margin-bottom: 20px;">
            ...
            <p align="justify"><strong>Javier Sharvel Irigoyen Matos:</strong> Me encargué de la elaboración de los 9 <em>Bounded Context Canvases</em> del sistema SafeCar y diseñé en detalle el bounded context de <em>Driver Engagement</em>. Realicé entrevistas a conductores para levantar necesidades y comportamientos clave; a partir de ello, redacté historias de usuario con criterios de aceptación orientados a la gestión de citas (programación, reprogramación, confirmación y cierre), asegurando trazabilidad con el lenguaje ubicuo y el <em>context mapping</em>. Trabajé en equipo para proporcionar liderazgo de forma conjunta, facilitando decisiones arquitectónicas y la integración entre dominios, y garantizando la coherencia funcional con los objetivos del negocio.</p>
            <p align="justify"><strong>Gonzalo Andre Zavala Quedena:</strong> Me encargué de la identificación y refinamiento de eventos, la documentación de los flujos de mensajes, la revisión y consolidación de los Bounded Context Canvases, la redacción y estructuración completa del Capítulo I (incluyendo perfiles y segmentos objetivo), la elaboración de User Personas para el Capítulo III, el diseño de la guía de entrevistas para usuarios y la elaboración de los diagramas de arquitectura de software a nivel de contenedores y contexto, asegurando claridad y cohesión en la visión del sistema.</p>
        </div>
        <!-- TP Section -->
        <div style="margin-bottom: 20px;">
        ...
        <div style="margin-bottom: 20px;">
            ...
            <p align="justify"><strong>Javier Sharvel Irigoyen Matos:</strong> Elaboré y detallé las historias de usuario y criterios de aceptación para las funcionalidades clave de WorkshopOps: programación automatizada de citas basada en telemetría, notificaciones por alertas detectadas y cierre de órdenes con evidencias telemétricas. También revisé y afiné el Bounded Context Canvas de WorkshopOps y ayudé a priorizar las reglas de negocio que habilitan la automatización operativa del taller.</p>
    ...
    <td style="text-align: left; vertical-align: top; padding: 15px;">
        ...
        <div style="margin-bottom: 15px;">
            ...
            <p align="justify">Durante el desarrollo del TP, el equipo consolidó su capacidad de liderazgo compartido, destacando en la implementación técnica del Capítulo VI y el diseño integral del Capítulo V. La coordinación entre el diseño UX/UI y la implementación técnica demostró madurez en la gestión de proyectos, mientras que la distribución equilibrada de responsabilidades entre configuration management, sprint planning, y desarrollo de interfaces aseguró la calidad y coherencia del sistema SafeCar implementado.</p>
        </div>
        <div style="margin-bottom: 15px;">
...
<tr>
    ...
    <td style="text-align: left; padding: 15px;">
        ...
        <div style="margin-bottom: 20px;">
            ...
            <p align="justify"><strong>Javier Sharvel Irigoyen Matos:</strong> Creé un entorno colaborativo e inclusivo facilitando espacios de trabajo donde todas las voces fueron consideradas; establecí metas claras por iteración (definir 9 <em>Bounded Context Canvases</em>, profundizar <em>Driver Engagement</em>, y cerrar historias de usuario con criterios de aceptación para la gestión de citas) y planifiqué las tareas de modelado, entrevistas a conductores, redacción de historias y validación del lenguaje ubicuo. Coordiné en conjunto con el equipo la priorización y los entregables, removiendo bloqueos y promoviendo acuerdos; como resultado, cumplimos los objetivos trazados: canvases consistentes, un BC de Driver Engagement listo para implementación y un set de historias alineadas al <em>context mapping</em> y a las necesidades reales de programación/reprogramación/confirmación de citas.</p>
            <p align="justify"><strong>Gonzalo Andre Zavala Quedena:</strong> Asumí un rol central en la planificación, coordinación y ejecución de tareas clave, promoviendo la colaboración y comunicación entre los miembros. Me encargué de la integración de aportes, la estructuración de entregables, la elaboración de perfiles y segmentos objetivo, la documentación de procesos y la generación de artefactos fundamentales para el avance del equipo, asegurando el cumplimiento de los objetivos y la calidad del trabajo final.</p>
        </div>
        <!-- TP Section -->
        <div style="margin-bottom: 20px;">
            <h4 style="color: #2c3e50; margin-bottom: 10px;">Entregable TP</h4>
            ...
            <p align="justify"><strong>Javier Sharvel Irigoyen Matos:</strong> Creé un entorno colaborativo e inclusivo durante el desarrollo integral del Capítulo V, facilitando talleres de diseño donde todos los miembros del equipo pudieron contribuir con perspectivas valiosas sobre la experiencia de usuario. Establecí metas específicas y medibles para cada fase del diseño: wireframes detallados, wireflow diagrams completos, mockups de alta fidelidad y prototipos interactivos funcionales. Planifiqué las tareas de prototipado de manera iterativa, asegurando ciclos de feedback constantes que mejoraran la calidad del diseño. Cumplí objetivos complejos al entregar prototipos interactivos completamente funcionales que validaron los flujos de usuario para gestión de citas y servicios, proporcionando al equipo de desarrollo especificaciones claras y probadas que facilitaron la implementación exitosa del Sprint 1.</p>
            <p align="justify"><strong>Gonzalo Andre Zavala Quedena:</strong> Creé un entorno colaborativo e inclusivo durante el desarrollo del Capítulo VI, estableciendo estándares de trabajo claros y facilitando la integración de aportes de todos los miembros del equipo en la configuración técnica del proyecto. Planifiqué meticulosamente las tareas de Software Configuration Management, definiendo objetivos específicos para la configuración del entorno de desarrollo, implementación de GitFlow, y establecimiento de convenciones de código que aseguraran la calidad y mantenibilidad del sistema. Cumplí objetivos técnicos complejos al coordinar la implementación exitosa del Sprint 1, integrando tecnologías como Vue.js con Options API, sistemas de internacionalización, y configuración de despliegue, mientras mantenía la coherencia entre todos los productos de SafeCar y facilitaba el trabajo colaborativo efectivo del equipo de desarrollo.</p>
            <p align="justify"><strong>Anaely Zarely Burga Loarte:</strong> Contribuí activamente a crear un entorno colaborativo e inclusivo durante el desarrollo del Capítulo V, participando equitativamente en las decisiones de diseño y apoyando en el establecimiento de procesos de retroalimentación constructiva. Colaboré en la planificación de las tareas de style guidelines y arquitectura de información de manera sistemática, apoyando en las metas establecidas para sistemas de organización, etiquetado y presentación de contenido que mejoren la experiencia de usuario. Cumplí objetivos de diseño asignados al contribuir con wireframes y mockups para la Landing Page, junto con elementos de sistemas de información que facilitaron la navegación intuitiva del sistema SafeCar durante el Sprint 1, asegurando que la propuesta de valor se comunique efectivamente y estableciendo bases sólidas para el desarrollo posterior del equipo.</p>
        </div>
        <!-- TB2 Section -->
        <div style="margin-bottom: 20px;">
            <h4 style="color: #2c3e50; margin-bottom: 10px;">Entregable TB2</h4>
            <p align="justify"><em>Resumen:</em> En Sprint 2 además de profundizar WorkshopOps, se avanzó en la implementación de la Web Application, Mobile Application y el Backend necesario para la ingestión y consumo de telemetría; estas piezas permiten exponer datos operativos, notificaciones y acciones automáticas a usuarios (talleres y conductores).</p>
            <p align="justify"><strong>Janover Gonzalo Saldaña Vela:</strong> Dirigí la planificación del Sprint 2, definiendo metas claras, criterios de aceptación y entregables asociados a WorkshopOps. Organicé las ceremonias (planning, daily y review), asigné tareas críticas y facilité la comunicación entre backend, frontend y QA para asegurar entregas alineadas a los objetivos del sprint. Validé integraciones entre Backend y Web/Mobile para la entrega de datos en tiempo real.</p>
            <p align="justify"><strong>Hardie Alfonso Holguin Gamarra:</strong> Coordiné las pruebas de integración con dispositivos y validaciones de seguridad para telemetría, documenté casos de prueba y lideré sesiones de testing con el resto del equipo para eliminar bloqueos. Trabajé con el Backend para asegurar que los mensajes de telemetría fueran seguros y fiables, y probé la correcta entrega de notificaciones a la Mobile Application.</p>
            <p align="justify"><strong>Javier Kenyi Mendoza Solis:</strong> Organicé las tareas de UI/UX vinculadas a WorkshopOps en el sprint backlog, entregué componentes iterativos del dashboard para la Web Application y adaptaciones para la Mobile Application. Facilité sesiones de feedback con usuarios representativos del taller y entregué la versión para la demo de sprint.</p>
            <p align="justify"><strong>Gustavo Jandroel Aguirre Rodríguez:</strong> Planifiqué e implementé las tareas de modelado de datos y optimización de consultas para soportar la carga de telemetría. Desarrollé servicios backend que exponen APIs consumidas por la Web y Mobile App y coordiné pruebas de rendimiento en entornos de staging.</p>
            <p align="justify"><strong>Javier Sharvel Irigoyen Matos:</strong> Organicé y distribuí historias y criterios de aceptación para el equipo, lideré la priorización colaborativa durante el planning y verifiqué que cada historia tuviera pruebas asociadas y evidencia para la demo de sprint. Aseguré que las historias contemplaran entregas para Web, Mobile y Backend.</p>
...
<div>
  <div>
    <table border="1" style="margin: auto; border-collapse: collapse; width: 100%; text-align: center;">
      <thead style="background-color: #f2f2f2;">
        <tr>
          <td><strong>Foto</strong></td>
          <td><strong>Nombre y Apellido</strong></td>
          <td><strong>Carrera</strong></td>
          <td><strong>Acerca de mí</strong></td>
...
<b style="color: #8c8c8cff;">Antecedentes</b>
<p align="justify">
En la realidad actual, gran parte de los conductores recurre al mantenimiento reactivo, lo que implica intervenciones urgentes que aumentan significativamente los costos, generan demoras imprevistas y elevan los riesgos de accidentes. Según estudios del ámbito industrial, el coste del mantenimiento reactivo puede ser entre 3 y 9 veces mayor que el de mantener un programa preventivo estructurado. Además, se ha estimado un retorno sobre la inversión de hasta el 545 % para estrategias preventivas, y una reducción múltiple de costos frente a arreglos de emergencia (ClickMaintain Fleet, 2024; SimplyFleet, 2025).
</p>

<b style="color: #8c8c8cff;">Problem Statement (5W’s y 2H’s)</b>

<b>What (¿Cuál es el problema?)</b>
<p align="justify">
Los conductores carecen de herramientas que les brinden información confiable y en tiempo real sobre el estado de sus vehículos. Esto genera mantenimientos tardíos, fallas imprevistas y mayor gasto en reparaciones.
</p>

<b>Where (¿Dónde surge el problema?)</b>
<p align="justify">
El problema aparece tanto en el uso cotidiano de vehículos particulares como en flotas empresariales y servicios de movilidad, donde la falta de control preventivo impacta en los costos y en la seguridad.
</p>

<b>Why (¿Por qué no se resuelve actualmente?)</b>
<p align="justify">
La mayoría de talleres carecen de integración tecnológica IoT, los vehículos más antiguos no cuentan con sistemas de autodiagnóstico modernos y los conductores tienden a posponer revisiones por desconocimiento o falta de alertas.
</p>

<b>When (¿Cuándo ocurre el problema?)</b>
<p align="justify">
Sucede de manera constante: al ignorar alertas tempranas, al no llevar un registro histórico de mantenimientos o cuando el vehículo presenta fallos inesperados en plena operación.
</p>

<b>Who (¿Quiénes están involucrados?)</b>
<p align="justify">
Conductores particulares, dueños de flotas, mecánicos y aseguradoras que deben enfrentar los altos costos de reparaciones imprevistas y accidentes por fallas técnicas.
</p>

<b>How (¿Cómo se maneja actualmente?)</b>
<p align="justify">
Con métodos tradicionales: visitas periódicas al taller, revisiones manuales, aplicaciones no integradas o simplemente esperando a que el vehículo falle.
</p>

<b>How Much (¿Cuánto cuesta este problema?)</b>
<p align="justify">
El mantenimiento correctivo puede ser entre <b>30% y 50% más costoso</b> que el preventivo (ResearchGate, 2023). Asimismo, por cada dólar invertido en mantenimiento preventivo se pueden ahorrar hasta 5 dólares en costos posteriores (UpKeep, 2022). En el caso de las flotas, las averías no planificadas generan pérdidas millonarias en logística y transporte (PMC, 2022).
</p>
...
<b>Domain</b>
<p align="justify">
El proyecto se enmarca en el <b>mantenimiento vehicular inteligente con IoT</b>, dentro del sector automotriz y tecnológico. SafeCar integra sensores y analítica de datos para transformar procesos de diagnóstico y prevención en automóviles, aplicando tecnología accesible tanto para conductores como para talleres mecánicos.
</p>

<b>Customer Segments</b>
<ul>
  <li align="justify">
    <b>Conductores particulares:</b> buscan reducir costos de mantenimiento, evitar fallas inesperadas y aumentar la seguridad de su vehículo.
  </li>
  <li align="justify">
    <b>Flotas pequeñas (ej. taxis, delivery, transporte urbano menor):</b> requieren optimizar mantenimientos preventivos para evitar interrupciones de servicio.
  </li>
  <li align="justify">
    <b>Talleres mecánicos independientes y medianos:</b> necesitan reportes automáticos y datos históricos de vehículos para reducir tiempos de diagnóstico y fidelizar clientes.
  </li>
</ul>

<b>Pain Points</b>
<ul>
  <li>Conductores sin información clara sobre el estado real de su vehículo.</li>
  <li>Costos elevados por reparaciones correctivas.</li>
  <li>Diagnósticos manuales en talleres que consumen tiempo y no cuentan con un historial detallado.</li>
  <li>Falta de integración tecnológica accesible en talleres pequeños y medianos.</li>
</ul>

<b>Gap (Brecha actual)</b>
<ul>
  <li>La mayoría de aplicaciones actuales de diagnóstico automotriz requieren vehículos modernos con sistemas avanzados (OBD-II), lo que excluye a gran parte del parque automotor en Latinoamérica.</li>
  <li>Los talleres independientes carecen de herramientas digitales avanzadas, dependiendo aún de revisiones manuales.</li>
  <li>No existe una solución local que combine IoT + plataforma web/móvil para unir directamente a conductores y talleres en tiempo real.</li>
</ul>
...
<ul>
  <li style="list-style-type: none;">
    <b style="color: #8c8c8cff;">Visión</b>
    <ul>
      <li>Convertir a SafeCar en la plataforma líder de mantenimiento vehicular preventivo en Latinoamérica.</li>
    </ul>
  </li>
  <li style="list-style-type: none;">
...
<b>Initial Segment</b>
El segmento inicial de lanzamiento estará compuesto por:
<ul>
  <li><b>Conductores particulares urbanos de entre 25 y 45 años</b>, con autos de uso personal o familiar.</li>
  <li><b>Talleres mecánicos medianos</b> en zonas urbanas, interesados en modernizar sus procesos y atraer más clientes ofreciendo diagnósticos rápidos y confiables.</li>
</ul>
...
<ol>
  <li align="justify">
    Existe un mercado en crecimiento de soluciones IoT aplicadas al mantenimiento vehicular.
  </li>
  <li align="justify">
    Los conductores y talleres están dispuestos a invertir en herramientas tecnológicas que reduzcan costos y mejoren la eficiencia.
  </li>
  <li align="justify">
    Una aplicación móvil con interfaz intuitiva aumentará la adopción.
  </li>
  <li align="justify">
    El uso de analítica predictiva será un valor diferencial frente a la competencia.
  </li>
</ol>
...
<ol>
  <li>Los conductores desean alertas claras y personalizadas.</li>
  <li>Los mecánicos requieren historiales y reportes automáticos.</li>
  <li>Los usuarios valoran la reducción de costos en mantenimiento.</li>
  <li>Prefieren aplicaciones móviles accesibles y fáciles de usar.</li>
</ol>

<b>Business Outcome Assumptions</b>
<ol>
  <li>La implementación de SafeCar generará un aumento en la retención de clientes para talleres mecánicos.</li>
  <li>Los talleres verán un incremento en la eficiencia operativa al utilizar herramientas digitales.</li>
  <li>SafeCar permitirá a los talleres acceder a nuevos segmentos de mercado, como conductores de vehículos más antiguos.</li>
</ol>

<b>User Outcome Assumptions</b>
<ol>
  <li>Los conductores se sentirán más seguros y confiados al recibir alertas tempranas.</li>
  <li>Los talleres mejorarán la precisión y rapidez en sus diagnósticos.</li>
  <li>Los usuarios ahorrarán tiempo y dinero al migrar de mantenimiento reactivo a preventivo.</li>
</ol>
...
<b>Hipótesis 1</b>
<p align="justify">
<b>Creemos que</b> los conductores adoptarán SafeCar si les ofrecemos una solución que les brinde alertas preventivas en tiempo real sobre el estado de su vehículo.
</p>

<p align="justify">
<b>Sabremos que</b> hemos tenido éxito cuando al menos el 70% de los conductores activos registren y consulten el historial de mantenimientos en la plataforma durante el primer mes de uso.
</p>
...
<p align="justify">
<b>Sabremos que</b> hemos tenido éxito cuando al menos el 60% de talleres reduzcan en un 25–30% el tiempo promedio de diagnóstico.
</p>

<b>Hipótesis 3</b>
<p align="justify">
<b>Creemos que</b> una interfaz intuitiva y accesible incrementará la tasa de adopción de SafeCar tanto en conductores como en talleres.
</p>

<p align="justify">
<b>Sabremos que</b> hemos tenido éxito cuando más del 80% de los usuarios consideren la aplicación fácil de usar en las primeras dos semanas.
</p>

<b>Hipótesis 4</b>
<p align="justify">
<b>Creemos que</b> los usuarios estarán dispuestos a pagar una suscripción premium si la plataforma ofrece funcionalidades avanzadas como reportes detallados, notificaciones inteligentes y acceso a historial completo.
</p>

<p align="justify">
<b>Sabremos que</b> hemos tenido éxito cuando al menos el 30% de los usuarios activos pasen a una suscripción premium en los primeros seis meses.
</p>

<b>Hipótesis 5</b>
<p align="justify">
<b>Creemos que</b> un soporte técnico accesible y programas de capacitación para talleres reducirán las barreras de adopción tecnológica.
</p>

<p align="justify">
<b>Sabremos que</b> hemos tenido éxito cuando la tasa de abandono se reduzca en un 15% durante el primer año.
</p>
...
<table style="width: 50%; border-collapse: collapse;">
    <tr>
        <td style="border: 1px solid black; text-align: justify; padding: 8px;">
            <span><strong>¿Cuál es el problema de negocio que estamos resolviendo?</strong></span>
            <p align="justify">
                Conductores y talleres enfrentan altos costos de mantenimiento reactivo, fallas inesperadas y diagnósticos lentos debido a la falta de soluciones tecnológicas accesibles y preventivas.
            </p>
        </td>
        <td style="border: 1px solid black; text-align: justify; padding: 8px;" rowspan="2">
            <span><strong>¿Qué soluciones ofrecemos para lograr este resultado?</strong></span>
            <p align="justify">
                SafeCar brinda una plataforma de mantenimiento preventivo basada en IoT que recopila datos en tiempo real del vehículo, genera alertas automáticas para conductores y provee reportes de diagnóstico para talleres.
            </p>
        </td>
        <td style="border: 1px solid black; text-align: justify; padding: 8px;">
            <span><strong>¿Cómo medimos el éxito?</strong></span>
            <p align="justify">
                Alcanzar un 70% de adopción en conductores y talleres en el primer año, reducir en un 30% las averías inesperadas y en un 25% el tiempo de diagnóstico en talleres, con un índice de satisfacción del cliente (CSAT) mayor al 90%.
            </p>
        </td>
    </tr>
    <tr>
        <td style="border: 1px solid black; text-align: justify; padding: 8px;">
          <span><strong>¿Quiénes son nuestros usuarios?</strong></span>
          <p>Nuestros usuarios incluyen:</p>
          <ul style="list-style-type: none; padding-left: 0;">
            <li><strong>Conductores particulares</strong> que buscan seguridad vial, reducción de costos imprevistos y confianza en el estado de su vehículo.</li>
            <li><strong>Talleres mecánicos independientes y medianos</strong> que necesitan agilizar diagnósticos, fidelizar clientes y optimizar sus procesos de mantenimiento.</li>
          </ul>
        </td>
        <td style="border: 1px solid black; text-align: justify; padding: 8px;">
            <span><strong>¿Qué esperamos que logren los usuarios?</strong></span>
            <p>Esperamos que nuestros usuarios logren:</p>
            <p align="justify">
                <b>Conductores:</b> Reducir averías imprevistas y ahorrar en reparaciones. <br>
                <b>Talleres:</b> Agilizar el diagnóstico de fallas y mejorar la experiencia del cliente mediante reportes automáticos.
            </p>
        </td>
    </tr>
    <tr>
        <td style="border: 1px solid black; text-align: justify; padding: 8px;">
          <p align="justify"><em>Si</em> los conductores reciben alertas preventivas, <em>entonces</em> reducirán las averías inesperadas en un 30%.</p>
          <p align="justify"><em>Si</em> los talleres acceden a reportes automáticos, <em>entonces</em> disminuirán en un 25% el tiempo de diagnóstico.</p>
          <p align="justify"><em>Si</em> la plataforma es intuitiva, <em>entonces</em> más del 80% de los usuarios la considerarán fácil de usar en las primeras semanas.</p>
          <p align="justify"><em>Si</em> se ofrecen funciones premium, <em>entonces</em> al menos el 30% de los usuarios estarán dispuestos a suscribirse.</p>
          <p align="justify"><em>Si</em> se brinda soporte técnico accesible, <em>entonces</em> la tasa de abandono se reducirá en un 15% el primer año.</p>
        </td>
        <td style="border: 1px solid black; text-align: justify; padding: 8px;">
            <span><strong>¿Qué es lo más importante que debemos aprender primero?</strong></span>
            <p align="justify">
                Validar si los conductores realmente consideran útiles las alertas preventivas y confirmar con talleres que los reportes automáticos son relevantes para mejorar su productividad.
            </p>
        </td>
        <td style="border: 1px solid black; text-align: justify; padding: 8px;">
            <span><strong>¿Cuál es la menor cantidad de trabajo que necesitamos hacer para aprender lo siguiente más importante?</strong></span>
            <p align="justify">
                Desarrollar un prototipo mínimo con alertas básicas para conductores y un reporte inicial para talleres, probarlo en un grupo piloto y recopilar feedback antes de escalar el desarrollo.
            </p>
        </td>
    </tr>
</table>
...
<table style="width:100%; border-collapse: collapse; text-align: center;">
  ...
  <tbody>
    <tr>
      <td style="border: 1px solid black; padding: 8px;"><strong>Conductores particulares (incluye taxis y delivery)</strong></td>
      ...
      <td style="border: 1px solid black; padding: 8px;" align="justify">
        <ul>
          <li><strong>Edad:</strong> 20 a 55 años</li>
          <li><strong>Educación:</strong> Variable; desde formación técnica hasta universitaria</li>
          <li><strong>Ocupación:</strong> Conductores de taxi, apps de movilidad, delivery o trabajadores con vehículo propio</li>
        </ul>
        <p><em>Sustento:</em> En Perú, solo el <strong>11.64 %</strong> de hogares posee un vehículo (AAP – INEI, 2023), lo que evidencia un mercado concentrado en zonas urbanas. Además, el sector de movilidad urbana y delivery crece a tasas superiores al <strong>10 %</strong> anual (Statista, 2023).</p>
      </td>
    </tr>
    <tr>
      <td style="border: 1px solid black; padding: 8px;"><strong>Talleres mecánicos independientes y medianos</strong></td>
      <td style="border: 1px solid black; padding: 8px;" align="justify">
        Localizados en áreas urbanas y periféricas del Perú, con alta concentración vehicular y demanda creciente de servicios de reparación y mantenimiento.
      </td>
      <td style="border: 1px solid black; padding: 8px;" align="justify">
        Se enfocan en mejorar la rapidez y precisión de sus diagnósticos, fidelizar clientes y competir mediante la adopción de soluciones digitales accesibles.
      </td>
      <td style="border: 1px solid black; padding: 8px;" align="justify">
        <ul>
          <li><strong>Edad:</strong> 30 a 60 años</li>
          <li><strong>Educación:</strong> Técnicos y profesionales en mecánica automotriz</li>
          <li><strong>Ocupación:</strong> Propietarios de talleres independientes, mecánicos certificados y asistentes técnicos</li>
        </ul>
        <p><em>Sustento:</em> En Perú existen alrededor de <strong>78,000 talleres mecánicos</strong>, de los cuales unos <strong>38,000</strong> se concentran en Lima, muchos con baja adopción tecnológica (AAP, 2021; TechSenati, 2022).</p>
      </td>
    </tr>
  </tbody>
</table>
...
<ul>
  ...
  <li><strong>URL del video:</strong> <a href="https://shorturl.at/D6sqC" target="_blank">https://shorturl.at/D6sqC</a></li>
...
<p align="justify">
<strong>Resumen:</strong> Kathy Gutiérrez es una ingeniera de 23 años residente de Lince, con un perfil pragmático y ocupado. Es una usuaria intensiva de smartphones y aplicaciones como WhatsApp, Facebook y servicios de taxi para optimizar su tiempo, pero mantiene un enfoque tradicional para el cuidado de su auto, dependiendo exclusivamente de su "mecánico de confianza" en lugar de herramientas digitales. Para futuras notificaciones, prefiere canales directos como WhatsApp o alertas de una aplicación nativa. Su comportamiento de mantenimiento es reactivo: lo realiza cada 8-9 meses solo cuando aparecen "ruidos extraños" o luces de advertencia. Sus frustraciones clave son el alto costo anual (4,000-5,000 soles), la falta de tiempo por su trabajo y una profunda desconfianza hacia los talleres. Por ello, busca una solución que le ofrezca control y predicción. Su funcionalidad ideal es una alerta que anticipe qué pieza específica está por fallar y su costo estimado, permitiéndole planificar sus finanzas y no perder días de trabajo. Está dispuesta a pagar una suscripción de 20 a 30 soles mensuales como una inversión para evitar gastos imprevistos y mayores.
</p>
...
<ul>
  ...
  <li><strong>URL del video:</strong> <a href="[URL]" target="_blank">https://shorturl.at/D6sqC</a></li>
  <li><strong>Duración:</strong> 4:16 min</li>
  <li><strong>Inicio de la entrevista:</strong> 0:06 min - 4:22 min</li>
...
<ul>
  ...
  <li><strong>Inicio de la entrevista:</strong> 8:47 min - 14:59 min</li>
  <li><strong>Screenshot:</strong></li>
</ul>
...
<ul>
  ...
  <li><strong>URL del video:</strong> <a href="https://shorturl.at/D6sqC" target="_blank">https://shorturl.at/loU4y</a></li>
  <li><strong>Duración:</strong> 03:09 min</li>
  <li><strong>Inicio de la entrevista:</strong> 8:47 min - 14:59 min</li>
  <li><strong>Screenshot:</strong></li>
</ul>
...
<ul>
  ...
  <li><strong>URL del video:</strong> <a href="https://shorturl.at/D6sqC" target="_blank">https://shorturl.at/D6sqC</a></li>
  <li><strong>Duración:</strong> 08:19 min</li>
  <li><strong>Inicio de la entrevista:</strong> 29:14 min - 37:30 min</li>
  <li><strong>Screenshot:</strong></li>
</ul>
...
<ul>
  ...
  <li><strong>URL del video:</strong> <a href="https://shorturl.at/D6sqC" target="_blank">
    https://shorturl.at/D6sqC
  </a></li>
  <li><strong>Duración:</strong> 10:39 min</li>
  <li><strong>Inicio de la entrevista:</strong> 18:34 min - 29:14 min</li>
  <li><strong>Screenshot:</strong></li>
</ul>
...
<p align="justify">
<strong>Resumen:</strong> La persona entrevistada es Jean Franco Quintana Carpo, de 26 años, mecánico practico y enérgico con 6–7 años de experiencia que actualmente supervisa a ocho técnicos y se encarga de asignar trabajos, realizar diagnósticos complejos, pruebas de ruta y apoyar en la comunicación técnica con clientes. Trabaja en un taller especializado mayormente en Chevrolet, donde toda la comunicación interna se gestiona vía WhatsApp mediante fotos y videos como evidencias, sistema que él mismo propuso. Aunque cuentan con herramientas como escáner y osciloscopio, los diagnósticos varían entre 30 minutos y 2 días según la complejidad, y pronto implementarán el sistema Sigma para agilizar la consulta de historiales.  Se apoya sobre todo en WhatsApp. Entre los principales retos destacan la falta de un especialista en electrónica, la carencia de diagramas eléctricos actualizados, la negativa a invertir en el programa oficial de Chevrolet, las dificultades para digitalizar procesos en taller y las quejas de clientes por demoras en la entrega de información. Pese a ello, ve con optimismo herramientas como Sigma, siempre que sean prácticas y fáciles de usar en el piso de trabajo.
</p>
